...
const init = () => {
  ...
  console.log(`[INIT]fetchLastDone = ${fetchLastDone}`)
  console.log(`[INIT]autoStatusCheck = ${autoStatusCheck}`);
  console.log(`[INIT]Sockeet Server Port = ${socketPort}`);

  return {logger,socketPort, fetchLastDone, autoStatusCheck};
}

module.exports = (function(){
  const {logger, socketPort, fetchLastDone, autoStatusCheck} = init();
